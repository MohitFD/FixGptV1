        ...
        if rows:
            ...
            for mp in rows:
                ...
                missed_cards.append({
                    ...
                    # ⭐ ADD THESE
                    "in_time": mp.get("in_time") or mp.get("pre_in_time") or "-",
                    "out_time": mp.get("out_time") or mp.get("pre_out_time") or "-",
...
def handle_attendance_report(decision: dict, token: str, request, user_message: str = ""):
    ...
    if not rows:
        ...
        reply = f"⚠️ Attendance data nahi mila {scope} ke liye." if user_message == "hi" else f"⚠️ No attendance found for {scope}."
...
def chat_history(request):
    ...
    # Add this function in views.py (around line 2800 ke baad)
