      ...
      # ---- Apply Leave ----
            ...
            try:
                ...
                check_params = {
                    ...
                    "master_module_id": 250,   # ✅ confirmed
                }
                r1 = requests.post(APPROVAL_CHECK_URL, headers=headers, params=check_params, timeout=15)
                ...
                handler_params = {
                    ...
                    "data[approval_status]": approval_status,
                    "data[approval_action_type]": step["pa_type"],       # e.g. single / anyone
                    "data[approval_type]": approval_type,                # 1=approve, 2=reject
                    "data[approval_sequence]": step["pa_sequence"],
                    "data[btc_id]": step["pa_am_id"],                    # ✅ corresponds to module id (86)
                    "data[blvr_id]": md5_hash(leave_id),                 # ✅ md5 hashed leave_id
                }
