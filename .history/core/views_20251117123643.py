...
- copy their date phrase exactly
- never calculate anything
- never interpret words
- never translate between languages
- never make assumptions
- never expand text or rewrite it
- never guess dates
- never add anything extra

If the message contains ANY form of “leave”, “chhutti”, “off”, “rest”, “absent”, “holiday” 
in Hindi/English/Hinglish → task = "apply_leave".

Copy EXACT user words in the "date" field.
Do NOT modify or generate new words.
