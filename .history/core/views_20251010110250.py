...
def chat_api(request):
    ...
    "POST_TYPE": "LEAVE_REQUEST_APPROVAL",
        ...
        # ---- Approve / Reject Leave ----
            ...
            try:
                # Expected format: approve leave|<leave_id>|<emp_d_id>|<note>
                ...
                approval_status = step["pa_status_id"] if approve else "158"  # 157=Approved, 158=Rejected
                approval_type = "1" if approve else "2"
                ...
                handler_params = {
                    ...
                    "data[approval_type]": approval_type,
                    "data[approval_sequence]": step["pa_sequence"],
                    "data[tc_trp_id]": md5_hash(leave_id),   # ✅ FixHR uses tc_trp_id for leave
                    "data[module_id]": md5_hash(step["pa_am_id"]),
                    "data[message]": note,
                    "data[master_module_id]": 250,
                    "data[is_last_approval]": step["pa_is_last"],
