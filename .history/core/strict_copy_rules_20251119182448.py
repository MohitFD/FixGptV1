...
def enforce_copy_rules(msg, decision):
    ...
    gatepass_keywords = [
        ...
        "lunch", "lunch break", "khana", "khane", "khane jana",
        "sutta break", "chai break", "break ke liye", "thodi der ke liye"
    ]
    ...
    return clean
if "miss" in msg.lower() or "punch" in msg.lower():
    decision["task"] = "apply_missed_punch"
