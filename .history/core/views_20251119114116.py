...
def chat_api(request):
    ...
    if task == "apply_leave":
        ...
        # Ensure we have both times before calling the API helper
        ...
        if (
            ...
            return JsonResponse({
                "reply": "Kis time se kis time tak bahar jana hai?"
            })

        # Use extracted times if the model didn't provide any
