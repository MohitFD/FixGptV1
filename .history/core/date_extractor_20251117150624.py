...
def extract_exact_date_phrase(text: str) -> str:
    ...
    patterns = [
        ...
        # 1. Hindi casual: "28 ko", "28 ke", "28 tareekh"
        r"\b\d{1,2}\s*(ko|ke|ki|tareekh)\b",

        # 2. "28 november", "5 dec", "2 january"
        ...
        # 3. "28-november", "28 - nov"
        r"\b\d{1,2}\s*[-]\s*(jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec|january|february|march|april|june|july|august|september|october|november|december)\b",

        # 4. Full date "28/11/2025", "15-12-25"
