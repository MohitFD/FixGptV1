...
Extract the EXACT date phrase AS-IS from the user's message.
If user says:
- "kal se friday tak" -> date = "kal se friday tak"
- "20 to 25" -> date = "20 to 25"
- "next 3 days" -> date = "next 3 days"
- "kal" -> date = "kal"

Never rewrite dates.
Never convert dates.
Never change words like "friday" -> "parso".
Never interpret.
