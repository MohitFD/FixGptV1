...
- Use simple Hinglish (Hindi + English mixed).
- If API result shows error → reply politely.
- Never show raw JSON or internal IDs.
- Speak like helpful office HR assistant.
"""
...
Generate a user-friendly reply:
"""
...
def chat_api(request):
    ...
    msg_lower = msg.lower()
    if "gatepass" in msg_lower and "list" in msg_lower:
        intent = "pending_gatepass"
    elif "pending gatepass" in msg_lower:
        intent = "pending_gatepass"
    elif "my gatepass" in msg_lower:
        intent = "pending_gatepass"
