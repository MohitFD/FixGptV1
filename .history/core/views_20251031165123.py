...
def chat_api(request):
    ...
    if request.method == "POST":
        ...
        💬 User Message: Show privacy policy
⚙️ Running in keyword-based mode (no AI model used)
Internal Server Error: /api/chat/
Traceback (most recent call last):
  File "C:\Users\dushy\AppData\Roaming\Python\Python312\site-packages\django\core\handlers\exception.py", line 55, in inner
    response = get_response(request)
               ^^^^^^^^^^^^^^^^^^^^^
  File "C:\Users\dushy\AppData\Roaming\Python\Python312\site-packages\django\core\handlers\base.py", line 204, in _get_response
    self.check_response(response, callback)
  File "C:\Users\dushy\AppData\Roaming\Python\Python312\site-packages\django\core\handlers\base.py", line 332, in check_response
    raise ValueError(
ValueError: The view core.views.chat_api didn't return an HttpResponse object. It returned None instead.
[31/Oct/2025 16:47:59] "POST /api/chat/ HTTP/1.1" 500 66252
[31/Oct/2025 16:48:07] "GET /chat/ HTTP/1.1" 200 20358
D:\fixgpt-main\core\views.py changed, reloading.
...
Traceback (most recent call last):
  ...
  File "C:\Users\dushy\AppData\Roaming\Python\Python312\site-packages\django\utils\autoreload.py", line 64, in wrapper
    fn(*args, **kwargs)
  File "C:\Users\dushy\AppData\Roaming\Python\Python312\site-packages\django\core\management\commands\runserver.py", line 134, in inner_run
    self.check(**check_kwargs)
  File "C:\Users\dushy\AppData\Roaming\Python\Python312\site-packages\django\core\management\base.py", line 492, in check
    all_issues = checks.run_checks(
                 ^^^^^^^^^^^^^^^^^^
  File "C:\Users\dushy\AppData\Roaming\Python\Python312\site-packages\django\core\checks\registry.py", line 89, in run_checks
    new_errors = check(app_configs=app_configs, databases=databases)
                 ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "C:\Users\dushy\AppData\Roaming\Python\Python312\site-packages\django\core\checks\urls.py", line 44, in check_url_namespaces_unique
    all_namespaces = _load_all_namespaces(resolver)
                     ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "C:\Users\dushy\AppData\Roaming\Python\Python312\site-packages\django\core\checks\urls.py", line 63, in _load_all_namespaces
    url_patterns = getattr(resolver, "url_patterns", [])
                   ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "C:\Users\dushy\AppData\Roaming\Python\Python312\site-packages\django\utils\functional.py", line 47, in __get__
    res = instance.__dict__[self.name] = self.func(instance)
                                         ^^^^^^^^^^^^^^^^^^^
  File "C:\Users\dushy\AppData\Roaming\Python\Python312\site-packages\django\urls\resolvers.py", line 718, in url_patterns
    patterns = getattr(self.urlconf_module, "urlpatterns", self.urlconf_module)
                       ^^^^^^^^^^^^^^^^^^^
  File "C:\Users\dushy\AppData\Roaming\Python\Python312\site-packages\django\utils\functional.py", line 47, in __get__
    res = instance.__dict__[self.name] = self.func(instance)
                                         ^^^^^^^^^^^^^^^^^^^
  File "C:\Users\dushy\AppData\Roaming\Python\Python312\site-packages\django\urls\resolvers.py", line 711, in urlconf_module
  ...
  File "D:\fixgpt-main\fixhr_gpt_local\urls.py", line 6, in <module>
    path("", include("core.urls")),
             ^^^^^^^^^^^^^^^^^^^^
  File "C:\Users\dushy\AppData\Roaming\Python\Python312\site-packages\django\urls\conf.py", line 39, in include  
  ...
  File "<frozen importlib._bootstrap_external>", line 995, in exec_module
  File "<frozen importlib._bootstrap>", line 488, in _call_with_frames_removed
  File "D:\fixgpt-main\core\urls.py", line 2, in <module>
    from . import views
  File "D:\fixgpt-main\core\views.py", line 1710
