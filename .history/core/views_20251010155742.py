        ...
        # ---- Approve / Reject Gatepass ----
            ...
            try:
                ...
                if not leave_dt:
                    ...
                    headers = {"Accept": "application/json", "authorization": f"Bearer {token}"}
                     data_payload = {
                                        "data[leave_category_id]": 207,   # ✅ Casual Leave (CL)
                                        "data[leave_type_id]": 201,       # ✅ Full Day
                                        "data[leave_type]": "CL",
                                        "data[from_date]": from_date,
                                        "data[to_date]": to_date,
                                        "data[day_type_id]": 201,         # ✅ 201 = Full Day
                                        "data[reason]": reason,
                                        "data[emp_d_id]": 153,            # ✅ your employee department ID
                                        "POST_TYPE": "LEAVE_REQUEST_APPLY",  # ✅ tested post type
                                    }
