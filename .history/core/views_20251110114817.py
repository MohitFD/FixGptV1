...
def understand_and_decide(msg):
    prompt = f"""
You are FixHR Smart Understanding Engine.
You must understand natural language Hindi / English / Hinglish.
...
{{
 "intent": one of ["apply_leave","apply_gatepass","apply_missed_punch","leave_balance","pending_leave","pending_gatepass","payslip","general"],
 "language": "hi" or "en",
 "date": extracted date if mentioned else null,
 "leave_type": "full" or "half" (only if leave),
