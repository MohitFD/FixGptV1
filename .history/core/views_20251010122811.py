...
def chat_api(request):
        ...
        # ---- Approve / Reject Gatepass ----
            ...
            try:
                ...
                headers = {"Accept": "application/json", "authorization": f"Bearer {token}"}
                        ...
                        # Try to find module_id dynamically from latest leave data
            module_id = lv.get("leave_am_id", 153)
            master_module_id = lv.get("leave_module_id", 250)
 ...
 = requests.post(APPROVAL_CHECK_URL, headers=headers, params=check_params, timeout=15)
