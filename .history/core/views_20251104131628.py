...
# === Load Fine-tuned FixGPT model ===
MODEL, TOKENIZER, LABELS = load_trained_model(model_path="./fixhr_model")
...
def chat_api(request):
    ...
    if request.method == "POST":
        ...
        try:
            if MODEL:
                print("⚙️ Running in AI model mode")
                intent, confidence = predict_intent(msg, MODEL, TOKENIZER, LABELS)
            else:
                print("⚙️ Running in keyword-based fallback mode (no AI model loaded)")
